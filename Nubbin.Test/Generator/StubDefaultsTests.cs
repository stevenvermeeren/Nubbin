...
public class StubDefaultsTests
{
    ...
    public void IsTaskIdentifiesTaskShapes(string typeName, bool expectedIsTask, bool expectedHasResult)
    {
        ...
        Assert.Equal(expectedIsTask, Nubbin.Generator.StubDefaults.IsTask(returnType, out var resultType));
    ...
    public void GetReturnExpressionUsesCompatibleDefaults(string typeName, string expectedExpression)
    {
        ...
        Assert.Equal(expectedExpression, Nubbin.Generator.StubDefaults.GetReturnExpression(returnType));
    }
    ...
    public void RequiresNotImplementedForNonNullableUnsupportedReference()
    {
        ...
        Assert.True(Nubbin.Generator.StubDefaults.RequiresNotImplemented(returnType));
    }
    ...
    public void ConstructibleNonNullableReferenceGetsNewInstance()
    {
        ...
        Assert.Equal("new global::Value()", Nubbin.Generator.StubDefaults.GetReturnExpression(returnType));
        Assert.False(Nubbin.Generator.StubDefaults.RequiresNotImplemented(returnType));
    }
}